...
class Player:
    ...
    sleeper_id: str = ""   # Sleeper player_id (team abbr for DEF); "" if unmatched
...
def week1_teams() -> list[tuple[str, TeamLineup, TeamLineup]]:
    ...
    cdz = TeamLineup("CDZ NUTZ", starters=[
        Player("Mayfield",       "QB",  19.78, sleeper_id="4892"),
        Player("Darnold",        "QB",  18.71, sleeper_id="4943"),
        Player("J.Taylor",       "RB",  17.36, sleeper_id="6813"),
        Player("Hubbard",        "RB",  10.59, sleeper_id="7594"),
        Player("Chase",          "WR",  16.45, sleeper_id="7564"),
        Player("Smith-Njigba",   "WR",  15.85, sleeper_id="9488"),
        Player("Lamb",           "WR",  14.12, sleeper_id="6786"),
        Player("McBride",        "TE",  12.22, sleeper_id="8130"),
        Player("DEN DEF",        "DEF",  7.51, sleeper_id="DEN"),
    ])
    big_chest = TeamLineup("Mr. Big Chest", starters=[
        Player("C.Williams",     "QB",  21.75, sleeper_id="11560"),
        Player("C.Brown",        "RB",  14.63, sleeper_id="9224"),
        Player("Barkley",        "RB",  12.83, sleeper_id="4866"),
        Player("Henry",          "RB",  15.06, sleeper_id="3198"),
        Player("Corum",          "RB",   8.73, sleeper_id="11586"),
        Player("A.Brown",        "WR",  14.15, sleeper_id="5859"),
        Player("Lemon",          "WR",   7.96, questionable=True, sleeper_id="13294"),
        Player("Bowers",         "TE",  12.72, sleeper_id="11604"),
        Player("NYG DEF",        "DEF",  5.76, sleeper_id="NYG"),
    ])

    # ---- MATCHUP 2: kyleullrich8 vs leagueisass ----
    kyle = TeamLineup("kyleullrich8", starters=[
        Player("Prescott",       "QB",  20.88, sleeper_id="3294"),
        Player("Goff",           "QB",  20.07, sleeper_id="3163"),
        Player("B.Robinson",     "RB",  19.55, sleeper_id="9509"),
        Player("Gibbs",          "RB",  20.25, questionable=True, sleeper_id="9221"),
        Player("McCaffrey",      "RB",  17.20, questionable=True, sleeper_id="4034"),
        Player("Nabers",         "WR",  10.36, questionable=True, sleeper_id="11632"),
        Player("Jefferson",      "WR",  13.82, sleeper_id="6794"),
        Player("Loveland",       "TE",  12.42, sleeper_id="12517"),
        Player("BAL DEF",        "DEF",  7.90, sleeper_id="BAL"),
    ])
    league = TeamLineup("leagueisass", starters=[
        Player("Mahomes",        "QB",  17.83, questionable=True, sleeper_id="4046"),
        Player("D.Jones",        "QB",  17.32, sleeper_id="5870"),
        Player("Love",           "RB",  13.69, sleeper_id="13287"),
        Player("Etienne",        "RB",  10.74, sleeper_id="7543"),
        Player("Judkins",        "RB",  10.19, sleeper_id="12512"),
        Player("Pickens",        "WR",  13.59, sleeper_id="8137"),
        Player("McConkey",       "WR",  10.79, sleeper_id="11635"),
        Player("Kraft",          "TE",   9.60, questionable=True, sleeper_id="9484"),
        Player("TB DEF",         "DEF",  5.64, sleeper_id="TB"),
    ])

    # ---- MATCHUP 3: Buc-cee's vs fjoutlet ----
    buccees = TeamLineup("Buc-cee's", starters=[
        Player("Burrow",         "QB",  21.67, sleeper_id="6770"),
        Player("Purdy",          "QB",  18.73, sleeper_id="8183"),
        Player("Cook",           "RB",  16.06, sleeper_id="8138"),
        Player("Irving",         "RB",  10.97, sleeper_id="11584"),
        Player("Skattebo",       "RB",  12.63, sleeper_id="12481"),
        Player("Harrison",       "WR",   9.01, sleeper_id="11628"),
        Player("Nacua",          "WR",  16.28, sleeper_id="9493"),
        Player("LaPorta",        "TE",   9.75, sleeper_id="10859"),
        Player("SF DEF",         "DEF",  6.26, sleeper_id="SF"),
    ])
    fjoutlet = TeamLineup("fjoutlet", starters=[
        Player("Dart",           "QB",  20.49, sleeper_id="12508"),
        Player("Hurts",          "QB",  20.26, sleeper_id="6904"),
        Player("K.Walker",       "RB",  14.08, sleeper_id="8151"),
        Player("Hampton",        "RB",  13.96, sleeper_id="12507"),
        Player("Rice",           "WR",  10.76, sleeper_id="10229"),
        Player("D.Moore",        "WR",  10.04, sleeper_id="4983"),
        Player("Olave",          "WR",  12.08, sleeper_id="8144"),
        Player("Schultz",        "TE",   6.88, sleeper_id="5001"),
        Player("HOU DEF",        "DEF",  7.42, sleeper_id="HOU"),
    ])

    # ---- MATCHUP 4: AZ Rapids vs omaralb ----
    az = TeamLineup("AZ Rapids", starters=[
        Player("J.Allen",        "QB",  23.30, sleeper_id="4984"),
        Player("Nix",            "QB",  19.74, sleeper_id="11563"),
        Player("Jacobs",         "RB",  12.77, questionable=True, sleeper_id="5850"),
        Player("K.Williams",     "RB",  12.73, sleeper_id="8150"),
        Player("T.Henderson",    "RB",  10.79, sleeper_id="12529"),
        # Two empty WR slots — no player object added
        Player("Andrews",        "TE",   8.92, sleeper_id="5012"),
        Player("PIT DEF",        "DEF",  8.61, sleeper_id="PIT"),
    ])
    omar = TeamLineup("omaralb", starters=[
        Player("L.Jackson",      "QB",  22.14, sleeper_id="4881"),
        Player("B.Hall",         "RB",  12.57, sleeper_id="8155"),
        Player("Swift",          "RB",  11.65, sleeper_id="6790"),
        Player("St.Brown",       "WR",  16.26, sleeper_id="7547"),
        Player("Collins",        "WR",  13.99, sleeper_id="7569"),
        Player("Flowers",        "WR",  13.32, questionable=True, sleeper_id="9997"),
        Player("D.Smith",        "WR",  12.23, questionable=True, sleeper_id="7525"),
        Player("Kelce",          "TE",   9.28, sleeper_id="1466"),
        Player("DET DEF",        "DEF",  7.78, sleeper_id="DET"),
    ])

    # ---- MATCHUP 5: The Sopranos vs The Notorious Ones ----
    sopranos = TeamLineup("The Sopranos", starters=[
        Player("Herbert",        "QB",  19.68, sleeper_id="6797"),
        Player("Lawrence",       "QB",  19.57, sleeper_id="7523"),
        Player("Achane",         "RB",  15.89, sleeper_id="9226"),
        Player("J.Warren",       "RB",  11.71, sleeper_id="8228"),
        Player("McMillan",       "WR",  11.72, sleeper_id="12526"),
        Player("Burden",         "WR",  10.49, questionable=True, sleeper_id="12519"),
        Player("Tyson",          "WR",   8.96, sleeper_id="13281"),
        Player("T.Warren",       "TE",  10.66, sleeper_id="12518"),
        Player("PHI DEF",        "DEF",  8.15, sleeper_id="PHI"),
    ])
    notorious = TeamLineup("The Notorious Ones", starters=[
        Player("Maye",           "QB",  20.03, sleeper_id="11564"),
        Player("Daniels",        "QB",  20.95, sleeper_id="11566"),
        Player("Jeanty",         "RB",  13.31, sleeper_id="12527"),
        Player("J.Williams",     "RB",  13.44, sleeper_id="7588"),
        Player("London",         "WR",  12.76, sleeper_id="8112"),
        Player("Higgins",        "WR",  13.92, sleeper_id="6801"),
        Player("Waddle",         "WR",  12.19, questionable=True, sleeper_id="7526"),
        Player("H.Henry",        "TE",   7.60, sleeper_id="3214"),
        Player("SEA DEF",        "DEF",  9.11, sleeper_id="SEA"),
    ])
